  ...
  return (
    <form className="space-y-6" onSubmit={handleUploadVideo}>
            ...
            <div className="space-y-2">
              ...
              <Textarea id="transcription_prompt" ref={promptInputRef} disabled={status !== 'waiting'} className="h-20 leading-relaxed resize-none" placeholder="Inclua palavras-chaves mencionadas no video separadas por virgula (,)" />
            </div>
